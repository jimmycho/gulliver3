...
<body leftmargin="0" topmargin="0">
		<div  height="23" colspan="10" align="center" ><img style="width: 753px; " src="../../images/userInfo2.jpg">  
		<table class="BTABLE" style="width:800px;">
			<tr>
				<td class="BTD" height="20" colspan="3" align="center"><strong>${dto.name}회원님의 정보입니다</strong></td>
			</tr>
			<TR>
		...
		<input type='button' value='정보수정'
			onclick="location.href='update?userid=${dto.userid}'" class="BBUTTON">
